...
<li id="delete"><a href="#" onclick="formSubmit('${ctx}/dept/delete','_self');this.blur();">删除</a></li>
</shiro:hasPermission>
</ul>
  </div>
</div>
...
<table id="ec_table" class="tableRegion" width="98%" >
    ...
    ${page.links }<!-- 调用page的getLinks方法，获取分页标签 -->
	...
	<c:forEach items="${page.results }" var="dept"  varStatus="st">
		<tr align="left" class="odd" onmouseover="this.className='highlight'" onmouseout="this.className='odd'" >
			...
			<td><a href="${ctx }/dept/toview?id=${dept.id }">${dept.deptName }</a></td>
		</tr>
   </c:forEach>
	</tbody>
</table>
