...
<div id="innerMenubar">
  <div id="navMenubar">
<ul>
<li id="save"><a href="#" onclick="formSubmit('${ctx}/user/insert','_self');this.blur();">保存</a></li>
		...
		<table class="commonTable" cellspacing="1">
        	...
        	<tr>
	            ...
	            <td class="tableContentAuto">
	            	<input type="radio" name="state" value="1" checked="checked" class="input"/>启用
        	...
        	<tr>
	            ...
	            <td class="tableContent">
	            	<select name="userinfo.manager.id">
	            		<option>--请选择--</option>
	            		<c:forEach items="${userList}" var="user1">
	            			<option value="${user1.id}">${user1.userinfo.name}</option>
	            		</c:forEach>
	            	</select>
	            </td>
	        </tr>		
	        ...
	        <tr>
	            ...
	            <td class="tableContentAuto">
	            	<input type="radio" name="userinfo.gender" value="1" checked="checked" class="input"/>男
